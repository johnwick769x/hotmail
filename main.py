...
def check_account(email, password):
    ...
    try:
        ...
        response = session.get("https://live.com/", headers=headers, allow_redirects=False)
        ...
        response = session.get("https://go.microsoft.com/fwlink/p/?linkid=2125442&clcid=0x40c&culture=fr-fr&country=fr", headers=headers, allow_redirects=False)
        ...
        response = session.post(f"https://login.live.com/GetCredentialType.srf?opid={opid}", headers=headers, json=data, allow_redirects=False)
        ...
        response = session.post(f"https://login.live.com/ppsecure/post.srf?cobrandid={cobrandid}", headers=headers, data=data, allow_redirects=False)
    ...
    response = session.post(url_post, headers=headers, data=data, allow_redirects=False)
    ...
    response = session.post(fmhf_action, headers=headers, data=data, allow_redirects=False)
    ...
    response = session.post("https://outlook.live.com/owa/0/service.svc?action=GetAccessTokenforResource&UA=0&app=Mail&n=14", headers=headers, allow_redirects=False)
    ...
    response = session.post(f"https://outlook.live.com/search/api/v2/query?n=55&cv={mscv}", headers=headers, json=data, allow_redirects=False)
